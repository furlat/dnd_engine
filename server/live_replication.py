"""Live replication scene surfaces for manual examples and local clients."""
...
def create_stream_pair() -> tuple[Entity, Entity]:
    ...
    """
    hero = create_goblin(name="Stream Hero", position=(1, 1), faction="heroes")
    monster = create_skeleton(name="Stream Skeleton", position=(2, 1), faction="monsters")
