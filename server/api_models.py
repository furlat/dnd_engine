...
class JoinGameRequest(BaseModel):
    ...
    faction: Optional[str] = None  # Assign all entities of this faction (alternative to entity_uuids)
...
class ActionResult(BaseModel):
    ...
    # NEW: All combat log entries generated by this action (CombatLogEntry.to_dict())
