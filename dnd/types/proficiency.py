"""Dependency-neutral proficiency grants used by creature progression."""
...
class ProficiencySourceSet(BaseModel):
    ...
    def has_expertise(self) -> bool:
        ...
        return self.is_proficient and self.has_mode(ProficiencyMode.EXPERTISE)
...
__all__ = ["ProficiencyMode", "ProficiencySourceSet"]
