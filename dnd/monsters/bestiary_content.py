...
_GOBLIN_WARDROBE = (
    _wardrobe_item("apparel.leather_boots.dark", BodyPart.FEET),
)
_GENERIC_CASTER_WARDROBES = MappingProxyType({
    "arcane": (
        _wardrobe_item("apparel.robes.hedge_wizard", BodyPart.BODY),
        _wardrobe_item("apparel.cloth_shoes", BodyPart.FEET),
    ),
    "dark": (
        _wardrobe_item("apparel.robes.dark_cultist", BodyPart.BODY),
        _wardrobe_item("apparel.cloth_shoes.dark", BodyPart.FEET),
    ),
    "divine": (
        _wardrobe_item("apparel.robes.priest_vestments", BodyPart.BODY),
        _wardrobe_item("apparel.sandals.rope", BodyPart.FEET),
    ),
    "necromancer": (
        _wardrobe_item("apparel.robes.necromancer", BodyPart.BODY),
        _wardrobe_item("apparel.cloth_shoes.dark", BodyPart.FEET),
    ),
})
