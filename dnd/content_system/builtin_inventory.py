...
from dnd.content_system.body_definitions import (
    BODY_BEHAVIOR_DECLARATIONS, BODY_BEHAVIOR_DECLARATIONS_BY_CLASS,
)
...
from dnd.monsters.demon_variants import DEMON_VARIANT_DECLARATIONS
...
if len(_BUILT_IN_BEHAVIOR_DECLARATIONS_BY_CLASS) != len(_BUILT_IN_CLASS_BEHAVIOR_IDS):
