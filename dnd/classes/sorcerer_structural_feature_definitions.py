...
SORCERER_STRUCTURAL_FEATURE_DECLARATIONS_BY_CLASS = MappingProxyType({
    marker_type: get_content_declaration(marker_type)
    for marker_type in _STRUCTURAL_DEFINITION_BY_MARKER
})
