...
def main() -> None:
    """Generate backend manifest plus frontend manifest and TypeScript models."""
    parser = argparse.ArgumentParser()
    parser.add_argument("--client-engine-dir", type=Path, required=True)
    ...
    write_or_check(args.client_engine_dir / "eventContract.generated.json", manifest_text, args.check)
    write_or_check(args.client_engine_dir / "eventModels.generated.ts", render_typescript(manifest), args.check)
