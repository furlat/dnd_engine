...
Run with server running: python -m cli.debug_api
"""
    ...
    try:
        ...
        if target_uuid:
            ...
            if movement and valid_positions:
                # Pick a position closer to enemy
