...
def test_eb_18_028_codex_orchestrator_builds_guarded_codex_exec_invocation() -> None:
    """EB-18-028: Codex orchestration uses codex exec and entity guards."""
    import cli.orchestrator as orchestrator
...
def test_eb_18_029_codex_stream_metrics_track_current_item_events(tmp_path: Path) -> None:
    """EB-18-029: Codex item streams count commands, usage, and trajectory steps."""
    import cli.orchestrator as orchestrator
...
def test_eb_18_029_combat_log_filter_reveals_only_parent_marked_aoe_targets() -> None:
    """EB-18-029: AoE log filtering reveals only targets marked by the parent log."""
    from cli.log_filter import ANON_NAME, filter_combat_log
...
def run_all_tests() -> None:
    ...
    tests = [
        ...
        test_eb_18_028_codex_orchestrator_builds_guarded_codex_exec_invocation,
        ...
        test_eb_18_029_combat_log_filter_reveals_only_parent_marked_aoe_targets,
    ]
    for test in tests:
        test()
