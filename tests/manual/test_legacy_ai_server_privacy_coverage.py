...
LEGACY_CASES = (
    ...
    _row(
        ...
        "Execution now crosses the same typed epoch command boundary used by live agents.",
    ),
    _row(
        "examples/ai/test_ai_framework.py",
    ...
    _row(
        ...
        S,
        "tests/manual/test_39_ai_validation_harness.py::test_external_selfplay_runs_sorcerer_barbarian_duel_through_epoch_commands",
        "The maintained real self-play drives both faction controllers through accepted typed epoch commands, distinct session turns, movement, and attacks.",
    ),
    _row(
        "examples/ai/test_ai_framework.py",
    ...
    _row(
        ...
        "test_aoe_via_api",
        S,
        "tests/engine_book/test_manual_21_arena_game_sessions_client_state.py::test_aoe_spell_executes_through_canonical_action_and_replication_routes",
    ...
    _row(
        ...
        "test_get_equipment",
        R,
        "tests/engine_book/test_chapter_18_encounters_apis.py::test_eb_18_036_equipment_mutations_acknowledge_and_replicate_loadout",
    ...
    *(
        _row(
            ...
            case,
            S,
            "tests/engine_book/test_chapter_18_encounters_apis.py::test_eb_18_035_handler_toggle_round_trip_exposes_only_player_choices",
    ...
    _row(
        ...
        "test_jump_via_api",
        S,
        "tests/engine_book/test_manual_21_arena_game_sessions_client_state.py::test_jump_executes_through_canonical_action_and_replication_routes",
    ...
    _row(
        ...
        "test_self_action",
        S,
        "tests/engine_book/test_manual_21_arena_game_sessions_client_state.py::test_available_actions_action_results_and_log_cursors_drive_the_client_loop",
    ...
    _row(
        ...
        "test_end_turn",
        S,
        "tests/engine_book/test_chapter_18_encounters_apis.py::test_eb_18_037_turn_switch_updates_session_authority",
    ...
    _row(
        ...
        S,
        "tests/engine_book/test_chapter_12_senses_light_stealth.py::test_eb_12_032_hidden_transition_invalidates_subjective_occupancy_paths",
    ...
    _row(
        ...
        S,
        "tests/engine_book/test_chapter_12_senses_light_stealth.py::test_eb_12_031_perception_thresholds_refilter_contacts_hazards_and_logs",
    ...
    *(
        _row(
            ...
            case,
            S,
            "tests/engine_book/test_chapter_12_senses_light_stealth.py::test_eb_12_029_invisible_collision_stops_repaths_and_preserves_invisibility",
    ...
    *(
        _row(
            ...
            case,
            A,
            "tests/engine_book/test_chapter_12_senses_light_stealth.py::test_eb_12_030_multi_entity_spells_reject_unperceived_explicit_targets",
    ...
    *(
    ...
    _row(
        ...
        S,
        "tests/engine_book/test_chapter_12_senses_light_stealth.py::test_eb_12_024_sensory_dispatch_targets_own_perception_conditions",
    ...
    _row(
        ...
        R,
        "tests/engine_book/test_manual_21_arena_game_sessions_client_state.py::test_player_replication_describes_the_subjective_live_arena",
