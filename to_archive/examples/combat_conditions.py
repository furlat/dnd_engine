...
documented by the project. Since dice rolls are random, we test the MODIFIERS
that conditions apply, which are deterministic.

Expected Condition Effects:
...
def main():
    ...
    print("=" * 70)
    print("\nTesting all conditions against expected effects")
