...
def test_scroll_fireball_actual_damage():
    ...
    assert 4 <= dmg1 <= 48, f"Fireball damage should be 4-48 after save-for-half, got {dmg1}"
    assert 4 <= dmg2 <= 48, f"Fireball damage should be 4-48 after save-for-half, got {dmg2}"
    assert scroll.uuid not in caster.inventory.items
