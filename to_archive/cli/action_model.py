...
class ShortcutRegistry:
    ...
    def __init__(self):
        self._action_to_shortcut: Dict[str, str] = {}
        self._shortcut_to_action: Dict[str, str] = {}
...
class AvailableAction:
    ...
    The target_type field keeps the full server value, such as self, entity,
    multi_entity, position_path, position_los, or position_aoe.
    """
    template_name: str
    display_name: str
    target_type: str
...
class AvailableActionsState:
    ...
    other_entity: List[AvailableAction] = field(default_factory=list)
    movement: List[AvailableAction] = field(default_factory=list)
    spell_actions: List[AvailableAction] = field(default_factory=list)
    self_actions: List[AvailableAction] = field(default_factory=list)
    item_use_actions: List[AvailableAction] = field(default_factory=list)
    object_actions: List[AvailableAction] = field(default_factory=list)
