import { PLAYER_REPLICATION_CONTRACT_HASH, PLAYER_REPLICATION_CONTRACT_VERSION, } from "../index.js";
const appearance = {
    portrait_key: null,
...
export function entity(uuid, name, position) {
    return {
        uuid,
        content_ref: {
...
export function bootstrap(generationId = "generation-a") {
    return {
        protocol: {
        ...
        world: {
            state: {
                ...
                encounter: {
                    ...
                    initiative_order: [
                        { uuid: "hero", name: "Hero", initiative: 15, life_state: "alive" },
                        { uuid: "monster", name: "Monster", initiative: 10, life_state: "alive" },
                    ],
                },
                floor_objects: [],
            },
...
export function replicationFrame(cursor = 1) {
    return {
        source_stream_id: "stream-a",
...
export function syncDelivery(captured = 1) {
...
export function frameDelivery(cursor = 1) {
    return { kind: "frame", frame: replicationFrame(cursor) };
}
export function hiddenLogDelivery(cursor = 1, eventCursor = 1) {
    return {
        kind: "combat_log",
...
export function objectiveStepFrame(cursor = 1) {
    const event = {
        name: "Step",
        uuid: `step-${cursor}`,
...
export function watermarks(source = 0, observation = 0, presentation = 0, log = 0) {
    return {
